...
class NotificationChannel(BaseModelNoPK):
    __tablename__ = "sd_notification_channel"
    ...
    handler_class: Mapped[str | None] = mapped_column(String(200), name="handler_class", nullable=True)

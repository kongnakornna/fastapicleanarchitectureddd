<#
.SYNOPSIS
    create_modules_money.ps1 — Production-ready module generator (DDD + Clean Architecture)
.DESCRIPTION
...
Write-Host " create_modules_money.ps1 — DDD + Clean Arch"      -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan

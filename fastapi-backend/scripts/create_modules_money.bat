@echo off
REM =================.\create_modules_money.bat --all===========================================
REM  create_modules_money.bat
...
REM
REM  Usage:
REM    create_modules_money.bat <module> [layer] [prefix] [options]
REM
REM  Options:
...
:run
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0create_modules_money.ps1" %PSARGS%
set EXITCODE=%ERRORLEVEL%
if %EXITCODE% NEQ 0 (
    echo.
    echo [ERROR] create_modules_money.ps1 exited with code %EXITCODE%
)
echo.
pause
exit /b %EXITCODE%
...
echo.
echo ============================================================
echo  create_modules_money.bat — Module Generator (DDD + Clean Arch)
echo ============================================================
echo.
echo Usage:
echo   create_modules_money.bat ^<module^> [layer] [prefix] [options]
echo.
echo Arguments:
...
echo.
echo Examples:
echo   create_modules_money.bat inventory 3 inv --all
echo   create_modules_money.bat money 2 mon --all --force
echo   create_modules_money.bat money 2 mon --update
echo   create_modules_money.bat money 2 mon --skip
echo   create_modules_money.bat help
echo.
echo ============================================================
echo.
pause

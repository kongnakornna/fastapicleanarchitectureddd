...
PS D:\python-ddd-clean-arch\scripts> .\create_modules.bat --all
.\create_modules.bat --all


.\create_modules.bat money 2 mon --all
# หรือ
.\create_modules.bat inventory 3 inv --all --force



.\create_modules.bat --all
.\create_modules.bat 123abc --all
.\create_modules.bat money 2 mon --all --shared-core
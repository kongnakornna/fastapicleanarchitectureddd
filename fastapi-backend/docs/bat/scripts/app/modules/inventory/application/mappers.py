"""Inventory mappers — ตัวแปลงข้อมูล"""
...
class InventoryMapper:
    """InventoryMapper — ตัวแปลง entity ↔ dict"""

    @staticmethod
    def to_dict(entity: Inventory) -> dict:
        return {
            "id": str(entity.id),
    ...
    @staticmethod
    def to_entity(data: dict) -> Inventory:
        return Inventory(
            code=data["code"],
            name=data["name"],
            amount=Money(
            ...
            status=InventoryStatus(data.get("status", "ACTIVE")),

"""tests/unit/test_inventory_use_cases.py — Application layer"""
...
def repo() -> AsyncMock:
    ...
    r.get_by_id.side_effect = lambda _id: MagicMock(spec=Inventory)
    return r
...
@pytest.fixture
def uc(repo, cache, event_bus, idem, tenant_ctx) -> CreateInventoryUseCase:
